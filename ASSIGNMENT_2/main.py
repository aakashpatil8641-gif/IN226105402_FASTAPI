...
orders        = []
order_counter = 1
feedback      = [] # Q3: Added feedback list
...
# min_price is already successfully implemented here
...
# Product Summary Dashboard (Must be before /{product_id})
...
# Get Only the Price of a Product (Must be before /{product_id})
...
def place_order(order_data: OrderRequest):
    ...
    order = {
        ...
        'total_price':      total,
        'status':           'pending', # Bonus: Changed from 'confirmed' to 'pending'
    }
    orders.append(order)
    order_counter += 1
